...
/* Define to 1 if you have the <inotifytools/inotify.h> header file. */
/* #undef HAVE_INOTIFYTOOLS_INOTIFY_H */
...
#define HAVE_MACH_O_ARCH_H 1

/* Define to 1 if you have the `MDItemCreate' function. */
#define HAVE_MDITEMCREATE 1
...
/* Define to 1 if you have the `NXGetLocalArchInfo' function. */
...
/* Define to 1 if you have the declartion of 'facilitynames' and to 0 if you
   don't. */
...
#define PACKAGE_STRING "libwired 1.0"
...
#define WI_DIGESTS 1
#define WI_CIPHERS 1
#define WI_PTHREADS 1

//#define WI_P7_ENCRYPTION_RSA_AES256_SHA1 1
